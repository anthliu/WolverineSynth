...
beat_key(6) = beat_key_gen([0.55 0.05 0.45 0.3], '>',...
    'cur_note.beats = str2num(beat_edit.String);');

beat_edit = uicontrol(note_length_gp,...
    'Style', 'edit',...
    'Units', 'normalized',...
    'Position', [0.7 0.05 0.25 0.3],...
    'String', '0.75');
